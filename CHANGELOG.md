...
* **New:** Slack support. Configure an app in Slack and supply its OAuth `xorb` token to send messages, images, and failure messages to channels in a Slack workspace.
